...
class Document(object):
    ...
    def _parse_mentions(self, mentions, tokens):
        ...
        for i, m in enumerate(mentions):
            try:
                ...
                logger.error(
                    f"Could not parse document {self.doc_idx} due to "
    ...
    def _parse_relations(self, relations) -> List[Relation]:
        ...
        for r in relations:
            ...
            try:
                ...
                raise KeyError(
                    f"Could not parse relations of document {self.doc_idx} "
    ...
    @staticmethod
    def from_dict(d: dict, doc_idx: int):
        ...
        # before attempting to create Document object
